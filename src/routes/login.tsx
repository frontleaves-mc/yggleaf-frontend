      ...
      <div className="flex flex-1 items-center justify-center bg-background p-6">
        <RiseTransition className="flex w-full max-w-[400px] flex-col items-center gap-8">
          ...
          <div className="flex flex-col items-center gap-3 lg:hidden">
            <div
              className="flex h-12 w-12 items-center justify-center rounded-xl bg-gradient-to-br from-primary to-primary text-base font-bold text-white shadow-lg shadow-primary/15"
              style={{ clipPath: 'polygon(8% 0%, 100% 0%, 92% 100%, 0% 100%)' }}
            >
              Y
            </div>
            <div className="flex flex-col items-center gap-0.5">
              ...
              <span className="text-xs text-muted-foreground">by FrontLeaves</span>
            </div>
          </div>
