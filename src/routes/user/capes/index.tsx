...
function CapeCard({
  ...
  return (
    ...
    >
      <div className="p-4">
        <div className="aspect-[2/3] rounded-none bg-gradient-to-b from-chart-4/5 via-chart-4/8 to-chart-4/15 mb-3 flex items-center justify-center relative overflow-hidden">
          <SkinPreview capeUrl={cape.texture_url} />
