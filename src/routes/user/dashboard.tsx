		...
		>
			...
			>
				...
				<motion.div variants={fadeUpDelay2}>
					<Card className="ring-0 relative overflow-hidden border border-border/60 bg-card/95 shadow-[0_16px_40px_-28px_oklch(0.18_0.025_195_/_0.18)]">
						<div className="pointer-events-none absolute top-0 left-0 h-[3px] w-full bg-gradient-to-r from-emerald-500/50 via-emerald-500/20 to-transparent dark:from-emerald-400/40" />

						<CardHeader className="gap-2 pb-4">
							<div className="flex items-center justify-between gap-2">
								<CardTitle className="text-base">服务器公告</CardTitle>
								<span className="inline-flex items-center gap-1.5 rounded-full border border-emerald-500/15 bg-emerald-500/[0.06] px-2.5 py-1 text-[11px] font-semibold text-emerald-600 dark:text-emerald-400">
						...
						<CardContent className="pt-0">
							<p className="text-[13px] leading-7 text-muted-foreground/80">
								欢迎来到
								Yggleaf。请先确认你的账号已绑定正确角色，这样皮肤与披风的配置才能即时生效。如果显示异常，优先检查档案绑定状态，再联系管理员处理。
							</p>
						</CardContent>
					</Card>
				</motion.div>
