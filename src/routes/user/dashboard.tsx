...
const mockAnnouncements = [
	{
		...
		content: "你可以在这里管理你的 Minecraft 皮肤和披风资源。开始浏览皮肤库，选择你喜欢的角色外观吧！",
		date: "2026-04-30",
	},
	{
		id: "2",
		title: "皮肤库全新上线",
		content: "我们已上线大量全新皮肤资源，快来挑选属于你的独特外观。如果你有自己喜欢的皮肤，也支持上传使用。",
		date: "2026-04-28",
	},
];
				...
				<section className="flex flex-col gap-3">
					...
					<div className="flex flex-col gap-2">
						{quickLinks.map((link) => (
							...
							>
								<div className={`flex size-7 shrink-0 items-center justify-center rounded-lg ${link.iconBg}`}>
