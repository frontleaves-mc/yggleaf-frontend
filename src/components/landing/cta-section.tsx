...
function CtaSection() {
  ...
  return (
    <section className="relative overflow-hidden border-y border-border bg-[oklch(0.17_0.018_238)] py-20 text-white">
      <div className="absolute inset-0 bg-noise opacity-60" />
      <div className="absolute inset-0 opacity-15 mc-grid-pattern" />
      <motion.div
      ...
      >
        <h2 className="max-w-3xl font-heading text-3xl font-semibold tracking-tight text-white md:text-5xl">
          准备好进入锋楪了吗
        </h2>
        ...
        <div className="mt-8 flex w-full max-w-md items-center gap-3 rounded-lg border border-white/15 bg-white/10 px-4 py-3 text-left backdrop-blur">
