    ...
    >
      <Card
        className={cn(
          ...
          "ring-0 hover:border-border hover:shadow-lg hover:shadow-primary/5",
          className,
        )}
      >
        {/* 顶部装饰线 — lagoon 渐变 */}
        <motion.div
          ...
          className="absolute top-0 left-6 right-6 h-px bg-gradient-to-r from-transparent via-primary/30 to-transparent"
        />
